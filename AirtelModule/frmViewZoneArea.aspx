<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmViewZoneArea.aspx.cs"
    Inherits="frmViewZoneArea" MasterPageFile="~/MasterPage2.master" %>
                                ...
                                <div class="table table-responsive   ">
                                    <asp:GridView ID="gvcomp" runat="server" AutoGenerateColumns="false" class="table table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Zone Area Name">
                                                <ItemTemplate>
                                                    <%#Eval("ZoneArea")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Zone Area PinCode">
                                                <ItemTemplate>
                                                    <%#Eval("ZoneAreaPinCode")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblupdate" runat="server" CommandArgument='<%#Eval("ZoneAreaID") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Active/Deactive">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lblactive" runat="server" OnClientClick="return confirm('click ok for modify this record?');"
                                                        class='<%#Eval("button") %>' CommandArgument='<%#Eval("ZoneAreaID") %>' CommandName="active"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
