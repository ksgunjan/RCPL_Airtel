<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmmanagerDashboardPRI.aspx.cs"
    Inherits="frmmanagerDashboardPRI" MasterPageFile="~/MasterPage2.master" %>
                ...
                <div class="panel">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <div class="row top_tiles">
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divprife">
                                        </div>
                                        <h3>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divpripostive">
                                        </div>
                                        <h3>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divpripending">
                                        </div>
                                        <h3>
                                            Revisit Audit</h3>
                                        <p>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divprinegative">
                                        </div>
                                        <h3>
                                            Negative Audit</h3>
                                        <p>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divprinotwork">
                                        </div>
                                        <h3>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divpritotalcasestart">
                                        </div>
                                        <h3>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divpritotalsubmit">
                                        </div>
                                        <h3>
                                ...
                                <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="tile-stats">
                                        ...
                                        <div class="count" runat="server" id="divpritotalscaneed">
                                        </div>
                                        <h3>
                            ...
                            <div id="div11" class="bg-white" runat="server">
                                <div class=" ac p10">
                                    <div class="col-sm-12">
                                        <b>PRI</b>
                                        <div class="p0-10">
                                        ...
                                        <div class="col-sm-6">
                                            <h3>
                                                <asp:Label ID="lblpritotalthismonth" runat="server" class="btn btn-warning btn-block pull-left"></asp:Label>
                                            </h3>
                                        </div>
                                        <div class="col-sm-6 pt10">
                                            <asp:DropDownList ID="ddlmonthpri" runat="server" AutoPostBack="true" class="form-control"
                                                OnSelectedIndexChanged="ddlmonthpri_SelectedIndexChanged">
                                        ...
                                        <asp:Chart ID="Chart3" runat="server" Height="300px" Width="900px">
                                            <Titles>
                            ...
                            <div id="divpritotaltoday" class="bg-white" runat="server">
                                <div class="ac p10">
                                    <div class="col-sm-4">
                                        <asp:Label ID="lblpripositive" runat="server" class="btn btn-success btn-block"></asp:Label>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Label ID="lblprinegative" runat="server" class="btn btn-danger btn-block"></asp:Label>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Label ID="lblpripending" runat="server" class="btn btn-warning btn-block"></asp:Label>
                                    </div>
                                </div>
                                <div class="clearfix pb10">
                                </div>
                            ...
                            <div class="bg-white" runat="server" id="div3">
                                <div class=" bg-info p10">
                                    <asp:DataList ID="dlfepri" runat="server" RepeatColumns="1" RepeatDirection="Horizontal"
                                        RepeatLayout="Flow" OnItemDataBound="dlfepri_ItemDataBound">
                                        <ItemTemplate>
                                            <asp:Label ID="lblname1pri" runat="server" class="btn btn-primary btn-sm pull-left"
                                                Text='<%#Eval("FE Name") %>'></asp:Label>
                                            <asp:Label ID="lbldatepri" runat="server" Visible="false" class="btn btn-primary btn-sm pull-right"
                                                Text=""></asp:Label>
                                            <asp:Label ID="lbltimepri" runat="server" Visible="false" class="btn btn-primary btn-sm pull-right"
                                                Text=""></asp:Label>
                                            <asp:GridView ID="gvfedetaillistpri" runat="server" class="table table-responsive table-hover table-bordered table-condensed"
                                            ...
                                            <asp:Label ID="lblmssgpri" runat="server" class="btn btn-sm- btn-danger" Visible="false"></asp:Label>
                                            <div class="border5">
                                            </div>
                                        </ItemTemplate>
                                    </asp:DataList>
