<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmViewZone.aspx.cs" Inherits="frmViewZone"
    MasterPageFile="~/MasterPage2.master" %>

<asp:Content ID="contheade" runat="server" ContentPlaceHolderID="head">
    <!----------------Bootstrp js-------------------->
                                    ...
                                    <asp:GridView ID="gvcomp" runat="server" AutoGenerateColumns="false" class="table table-hover "
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblupdate" runat="server" CommandArgument='<%#Eval("ZoneID") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Active/Deactive">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lblactive" runat="server" OnClientClick="return confirm('click ok for modify this record?');"
                                                        class='<%#Eval("button") %>' CommandArgument='<%#Eval("ZoneID") %>' CommandName="active"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
