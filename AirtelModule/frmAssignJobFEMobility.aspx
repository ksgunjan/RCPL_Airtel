<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAssignJobFEMobility.aspx.cs"
    Inherits="frmAssignJobFEMobility" MasterPageFile="~/MasterPage2.master" %>
                        ...
                        <div class="card-body">
                            <div class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="label label-info ml10 fs13">
                                        Today's Prescheduled Appointments.
                                    </div>
                                    <div class="label label-info mr10 pull-right fs14 " runat="server" id="totalcount">
                                    </div>
                                    <div class="clearfix pb10">
                                    </div>
                                    <div>
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6 row">
                                                    <asp:TextBox ID="txtsearch" runat="server" class="form-control" Placeholder="Enter Billed Ext ID or Party Name"></asp:TextBox>
                                                </div>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-6 row">
                                                <div class="col-sm-7 row">
                                                    Select Audit Case (Category Wise)</div>
                                                <div class="col-sm-5">
                                                    <asp:DropDownList ID="ddlprodbycat" runat="server" AutoPostBack="true" class="form-control focus pull-right"
                                        ...
                                        <asp:DataList ID="dlcomp" runat="server" class="" OnItemCommand="dlcomp_ItemCommand"
                                            ...
                                            <ItemTemplate>
                                                <h4>
                                                    <asp:Label ID="lblcmpaname" runat="server" class="label label-primary pull-left ml5"
                                                        Text='<%#Eval("Party Name") %>'></asp:Label>
                                                    <asp:LinkButton ID="lbviewnubmer" runat="server" class="fa fa-eye pull-right" CommandArgument='<%#Eval("Party Name") %>'
                                                        CommandName="Viewnum"></asp:LinkButton>
                                                    <asp:Label ID="hfallocateddate" runat="server" Visible="false" Text='<%#Eval("Allocated Date") %>' />
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="View Detail">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="hfbilledextid" runat="server" Value='<%#Eval("[Billed Ext ID]") %>' />
                                                                    ...
                                                                    <asp:HiddenField ID="hfGridAllcationDate" runat="server" Value='<%#Eval("Allocated Date","{0:dd/MMM/yyyy}") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                        ...
                                        <div class="white">
                                            <div class="col-sm-2">
                                                <div class="ac">
                                                    <asp:LinkButton ID="lnkbtnPgFirst" runat="server" CssClass="btn btn-warning btn-xs"
                                                        OnClick="lnkbtnPgFirst_Click">First</asp:LinkButton>
                                                    <asp:LinkButton ID="lnkbtnPgPrevious" runat="server" CssClass="ac btn btn-warning  btn-xs"
                                                        OnClick="lnkbtnPgPrevious_Click">Previous</asp:LinkButton>
                                                </div>
                                            </div>
                                            <div class="col-sm-8 pt3">
                                                <asp:DataList ID="DataListPaging" runat="server" RepeatDirection="Horizontal" OnItemCommand="DataListPaging_ItemCommand"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="Pagingbtn" runat="server" CssClass="ac btn btn-warning btn-xs"
                                                            CommandArgument='<%# Eval("PageIndex") %>' CommandName="Newpage" Text='<%# Eval("PageText")%>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:DataList>
                                            </div>
                                            <div class="col-sm-2">
                                                <asp:LinkButton ID="lnkbtnPgNext" runat="server" CssClass="ac btn btn-warning  btn-xs"
                                                    OnClick="lnkbtnPgNext_Click">Next</asp:LinkButton>
                                                <asp:LinkButton ID="lnkbtnPgLast" runat="server" CssClass="ac btn btn-warning btn-xs"
                                                    OnClick="lnkbtnPgLast_Click">Last</asp:LinkButton>
                                            </div>
                                            <div class="cb pb5">
                                            </div>
                                            <div class="ac">
                                                <asp:Label ID="lblpaging" runat="server" class="button small cut-corner" Text=""></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix pb10">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                                            ...
                                                                            <div id="divsuccessfirst" runat="server">
                                                                                <div class="form-group row">
                                                                                    <label class="col-sm-12 form-control-label text-info">
                                                                                        <h4 id="totalnumbercount" runat="server">
                                                                                        </h4>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="form-group row">
                                                    ...
                                                    <div id="panviewnum" runat="server" visible="false">
                                                        <h3>
                                                            A brief detail of client Number.</h3>
                                                        <div class="table-responsive">
                                                            <asp:GridView ID="gvnum" runat="server" AutoGenerateColumns="false" class=" table table-responsive"
                                                                Width="100%">
                                                                <Columns>
