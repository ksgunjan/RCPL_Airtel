<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMonthWorkAllocatedate.aspx.cs"
    Inherits="frmMonthWorkAllocatedate" MasterPageFile="~/MasterPage2.master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <strong>Reports of Monthly Work (By- Allocated Date)</strong>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-horizontal bg-info border-aero">
                            ...
                            <div class="table-responsive" runat="server" id="divexcel">
                                ...
                                <asp:GridView ID="gvprifixedline" runat="server" AutoGenerateColumns="false"
                                    class="table" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
