<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAddZoneArea.aspx.cs" Inherits="frmAddZoneArea"
                    ...
                    <ContentTemplate>
                        <div class="card-body">
                            <div class="form-horizontal">
                                ...
                                <asp:HiddenField ID="hfzoneareaid" runat="server" />
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Enter Zone Name</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="txtzoneareaname" class="form-control" required=""
                                            Placeholder="ZoneArea Name">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                <div class="Clearfix pb5">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Enter ZoneArea PinCode</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="txtzoneareapincode" class="form-control" required=""
                                            Placeholder="ZoneArea PinCode">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                <div class="Clearfix pb5">
                                ...
                                <%--<div class="form-group row">
                                <label class="col-sm-3 form-control-label">
                                    Select ZoneArea Name
                                </label>
                                <div class="col-sm-9">
                                    <asp:DropDownList runat="server" ID="ddlzonearea" class="form-control" required="">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="Clearfix pb5">
