<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmNegativeWeeklyReport.aspx.cs"
    Inherits="frmNegativeWeeklyReport" MasterPageFile="~/MasterPage2.master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>
                        Weekly Negative Case Report</h3>
                </div>
            </div>
                                ...
                                <asp:GridView ID="gvll" runat="server" class="table table-responsive" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="StatusUpdateDate" DataFormatString="{0:dd/MMM/yyyy}" HeaderText="Date"
                                            NullDisplayText="#" />
                                        <asp:BoundField DataField="StatusTime" HeaderText="Date" NullDisplayText="#" />
                                        ...
                                        <asp:BoundField DataField="NegativeCustSamKamMailDatetime" DataFormatString="{0:dd/MMM/yyyy}"
