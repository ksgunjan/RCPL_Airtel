<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAddZoneMapping.aspx.cs"
    Inherits="frmAddZoneMapping" MasterPageFile="~/MasterPage2.master" %>
                    ...
                    <ContentTemplate>
                        <div class="card-body">
                            <div class="form-horizontal">
                                ...
                                <asp:HiddenField ID="hfzonemapping" runat="server" />
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Select Zone Name</label>
                                    <div class="col-sm-9">
                                        <asp:DropDownList runat="server" ID="ddlzonename" class="form-control" required="">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Select ZoneArea Name</label>
                                    <div class="col-sm-9">
                                        <asp:DropDownList runat="server" ID="ddlzoneareaname" class="form-control" required="">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="Clearfix pb5">
