<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmviewZoneMapping.aspx.cs"
    Inherits="frmviewZoneMapping" MasterPageFile="~/MasterPage2.master" %>
                                ...
                                <div class="table table-responsive">
                                    <asp:GridView ID="gvcomp" runat="server" AutoGenerateColumns="false" class="table  table-hover  "
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Zone Area Code for Excel">
                                                <ItemTemplate>
                                                    <%#Eval("ZoneAreaCode")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblupdate" runat="server" CommandArgument='<%#Eval("ZoneMappingID") %>'
