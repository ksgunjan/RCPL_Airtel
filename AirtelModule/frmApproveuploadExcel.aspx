<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmApproveuploadExcel.aspx.cs"
    Inherits="frmApproveuploadExcel" MasterPageFile="~/MasterPage2.master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>
                        View Upload Excel for approval</h3>
                </div>
            </div>
            <div class="card">
                <asp:UpdatePanel ID="updatepanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="card-body">
                            <div>
                                ...
                                <div runat="server" id="divhideonallexcelclick">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5>
                                                Select upload excel <b>allocated date</b> for approve case and assign to FE</h5>
                                            <asp:TextBox ID="txtstartdate" runat="server" class="form-control" type="date" Placeholder="Select start date"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                            <h5 class="pull-right mr10">
                                                Click on Search to find result</h5>
                                            <div class="clearfix">
                                            </div>
                                            <asp:Button ID="btnsearch" runat="server" class="btn btn-success pull-right" Text="Search Upload Excel Record"
                                ...
                                <div class="table table-responsive">
                                    <div>
                                        <h4 runat="server" id="h4message">
                                        </h4>
                                    </div>
                                    <div class="pb-2">
                                    </div>
                                    <asp:Button ID="btnapproveuploadexcel" runat="server" Visible="false" class="btn btn-success pull-right mr10"
                                        Text="Approve Upload Excel" OnClick="btnapproveuploadexcel_Click" />
                                    <div class="pb-2">
                                    </div>
                                    <asp:GridView ID="gvexcel" runat="server" AutoGenerateColumns="false" class="table table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Cust Email" HeaderText="Customer Mail" NullDisplayText="#" />
                                           ...
                                           <%-- <asp:BoundField DataField="MappingID" HeaderText="FE Zone Location" />--%>
                    ...
                    <Triggers>
                        <%--<asp:PostBackTrigger ControlID="btnapproveuploadexcel" />--%>
                    </Triggers>
                </asp:UpdatePanel>
