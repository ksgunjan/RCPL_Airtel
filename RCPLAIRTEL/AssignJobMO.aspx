<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignJobMO.aspx.cs" Inherits="AssignJobMO" MasterPageFile="~/MasterPage.master" %>
                ...
                <div class="sideBg">
                    ...
                    <div class="section-pannel">
                        ...
                        <asp:GridView ID="gvexcel" runat="server" AutoGenerateColumns="false" class="commonAjaxTbl dataTable master-company-table ViewProductTable table 
                            ...
                            OnRowCreated="gvexcel_RowCreated" OnRowCommand="gvexcel_RowCommand" OnRowDataBound="gvexcel_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lblstatus" runat="server" class="fa fa-edit" CommandArgument='<%#Eval("Party_Name") %>'
                                            CommandName="UpdateStatus"></asp:LinkButton>
                                        <asp:LinkButton ID="lblview" runat="server" class="fa fa-eye" CommandArgument='<%#Eval("Party_Name") %>'
                                            CommandName="ViewDetail"></asp:LinkButton>
                                        <asp:LinkButton ID="lblviewnumbers" runat="server" class="fa fa-newspaper" CommandArgument='<%#Eval("Party_Name") %>'
                                            CommandName="Viewnum"> - <%#Eval("Count") %></asp:LinkButton>
                                        <asp:HiddenField ID="hfAllocatedDate" runat="server" Value='<%#Eval("Allocated_Date","{0:dd/MMM/yyyy}") %>' />
                                ...
                                <asp:TemplateField HeaderText="Billed Ext Id">
                                    <ItemTemplate>
                                        <asp:Label ID="lblbilledextid" runat="server" Text='<%# Eval("Billed_Ext_Id").ToString() == "" ? "#" : Eval("Billed_Ext_Id").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Coordinator Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcoordinatorname" runat="server" Text='<%# Eval("Coordinator_Name").ToString() == "" ? "#" : Eval("Coordinator_Name").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Coordinator Number">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcoordinatornumber" runat="server" Text='<%# Eval("Coordinator_Contact_number").ToString() == "" ? "#" : Eval("Coordinator_Contact_number").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
