<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAssignJobFEByManager.aspx.cs" Inherits="frmAssignJobFEByManager"
                ...
                <div class="sideBg">
                    <div class="row">
                        <div class="col-md-12 padding_0">
                            <ul class="breadcrumb">
                                <li>
                                    <asp:Label ID="lblPageName" runat="server" Text="Assign Job to Field Executive Leased Line"></asp:Label>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="section-pannel">
                        ...
                        <asp:GridView ID="gvexcel" runat="server" AutoGenerateColumns="false" class="table table-hover table-responsive table-bordered">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Complaince Date">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdnIDGridRawData" runat="server" Value='<%#Eval("Logical_Circuit_Id") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
