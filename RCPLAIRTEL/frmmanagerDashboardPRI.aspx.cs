...
public partial class frmmanagerDashboardPRI : System.Web.UI.Page
{
    ...
    {
        #region PRI
        DataTable DtGetCount = Lo.RetriveFunctionCode3(Session["Name"].ToString(), "", "", "", "");
    ...
    {
        DataTable DtgetotherdatalistcodeAll = Lo.RetriveCodeManagerDashboard(0, "", "", "", "", "", "", "", Convert.ToDateTime(DateTime.Now.ToString("dd/MMM/yyyy")), "FeLastVisitPRI");
        if (DtgetotherdatalistcodeAll.Rows.Count > 0)
        {
            dlfepri.DataSource = DtgetotherdatalistcodeAll;
            dlfepri.DataBind();
    ...
    protected void dlfepri_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            DataTable DTGetuserbyID = Lo.RetriveCodeManagerDashboard(0, "", hfid.Text, "", "", "", "", "", Convert.ToDateTime(DateTime.Now.ToString("dd/MMM/yyyy")), "FeVisitGetOneRowPRI");
    ...
    {
        DataTable DtAM = Lo.RetriveCodeLocal(0, ddlmonth.SelectedItem.Text, "PRI-Fixed Line", "", "CountADFE");
    ...
    {
        DataTable DtAM = Lo.RetriveCodeLocal(0, ddlmonth.SelectedItem.Text, "PRI-Fixed Line", "", "CountSUDFE");
        if (DtAM.Rows.Count > 0)
        {
            string[] x = new string[DtAM.Rows.Count];
            int[] y = new int[DtAM.Rows.Count];
