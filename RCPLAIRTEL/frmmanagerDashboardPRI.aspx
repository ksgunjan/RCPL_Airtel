<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmmanagerDashboardPRI.aspx.cs" Inherits="frmmanagerDashboardPRI"
        ...
        <div class="sideBg">
            <div class="row">
                <div class="col-mod-12 padding_0">
                    <ul class="breadcrumb">
                        <li>
                            <asp:Label ID="lblPageName" runat="server" Text="Dashboard PRI-Fixed Line"></asp:Label>
                        </li>
                    </ul>
                </div>
            </div>
