<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmNegativeWeeklyReport.aspx.cs" Inherits="frmNegativeWeeklyReport"
                ...
                <div class="sideBg">
                    <div class="row">
                        <div class="col-md-12 padding_0">
                            <ul class="breadcrumb">
                                <li>
                                    <asp:Label ID="lblPageName" runat="server" Text="Weekly Negative Case Report"></asp:Label>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="section-pannel">
                            ...
                            <asp:GridView ID="gvll" runat="server" class="commonAjaxTbl dataTable master-company-table ViewProductTable table 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Status_Update_Date" DataFormatString="{0:dd/MMM/yyyy}" HeaderText="Date"
                                        NullDisplayText="#" />
                                    <asp:BoundField DataField="Status_Time" HeaderText="Date" NullDisplayText="#" />
                                    ...
                                    <asp:BoundField DataField="Cust_Sam_Kam_Mail_Datetime" DataFormatString="{0:dd/MMM/yyyy}"
                                        HeaderText="Cust Neg Mail Date" NullDisplayText="#" />
                                    <asp:BoundField DataField="Negative_Cust_Sam_Kam_Mail_Datetime" DataFormatString="{0:dd/MMM/yyyy}"
                        ...
                        <div style="overflow: auto;">
                            <asp:GridView ID="gvmo" runat="server" class="commonAjaxTbl dataTable master-company-table ViewProductTable table 
                                        display responsive no-wrap table-hover manage-user Grid table-responsive"
                                AutoGenerateColumns="false" OnRowCreated="gvmo_RowCreated">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>
