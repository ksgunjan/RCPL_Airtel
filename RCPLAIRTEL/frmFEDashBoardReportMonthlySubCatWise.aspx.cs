...
public partial class frmFEDashBoardReportMonthlySubCatWise : System.Web.UI.Page
{
    ...
    {
        DTSearch = Lo.RetriveCodeReport1("", "", "LLReport");
    ...
    {
        DTSearch = Lo.RetriveCodeReport1("", "", "MOReport");
        if (DTSearch.Rows.Count > 0)
        {
    ...
    {
        DTSearch = Lo.RetriveCodeReport1("", "", "PRIReport");
        if (DTSearch.Rows.Count > 0)
        {
    ...
    {
        DTSearch = Lo.RetriveCodeReport1("", "", "LLRepoType2");
        if (DTSearch.Rows.Count > 0)
        {
    ...
    {
        DTSearch = Lo.RetriveCodeReport1("", "", "MORepoType2");
        if (DTSearch.Rows.Count > 0)
        {
    ...
    protected void btnreport_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable dtll = Lo.RetriveCodeReport1("", "", "LLMail");
            DataTable dtmo = Lo.RetriveCodeReport1("", "", "MOMail");
            DataTable dtpri = Lo.RetriveCodeReport1("", "", "PRIMail");
